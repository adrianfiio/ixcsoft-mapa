...
class MapV07534ContractTests(unittest.TestCase):
    ...
    def test_version_is_07534(self):
        ...
        self.assertIn('MAP_VERSION = os.getenv("MAP_VERSION", "0.75.38")', settings)
        self.assertIn("MAP_VERSION: ${MAP_VERSION:-0.75.38}", compose)
        self.assertIn("Mapa | v0.75.38", versions)
