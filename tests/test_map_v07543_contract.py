...
class MapV07543ContractTests(unittest.TestCase):
    def test_rack_canvas_has_background_pan(self):
        runtime = content("static/js/map-rack-routing-v07543.js")
        css = content("static/css/map-rack-routing-v07543.css")
        self.assertIn("function installPan", runtime)
        self.assertIn("scroll.scrollLeft", runtime)
        self.assertIn("scroll.scrollTop", runtime)
        self.assertIn("v07543-pan-enabled", css)
        self.assertIn("is-panning-v07543", css)
    ...
    def test_old_routing_is_replaced_by_organizer_routing(self):
        ...
        self.assertIn('svg[data-rack-links-v07542]', css)
    ...
    def test_olt_has_separate_uplink_panel(self):
        runtime = content("static/js/map-rack-routing-v07543.js")
        css = content("static/css/map-rack-routing-v07543.css")
        self.assertIn("ensureOltBottomGrid", runtime)
        self.assertIn("v07543-olt-service-tail", runtime)
        self.assertIn("v07543-olt-uplinks", runtime)
        self.assertIn("UPLINKS", runtime)
        self.assertIn("grid-template-columns: minmax(0, 1.18fr) minmax(220px, .82fr)", css)
    ...
    def test_uplink_editor_supports_rj45_sfp_and_sfp_plus(self):
        ...
        self.assertIn("openUplinkEditor", runtime)
        self.assertIn("save_uplink", runtime)
    ...
    def test_service_cards_have_model_and_technology_editor(self):
        ...
        self.assertIn("Botão direito: editar placa", runtime)
    ...
    def test_urls_template_and_version_are_current(self):
        ...
        self.assertIn("map-rack-routing-v07543.js", template)
        self.assertIn("map-rack-routing-v07543.css", template)
        ...
        self.assertIn("MAP v0.75.43", content("docs/releases/map/map-v0.75.43.md"))
