...
class MapV07542ContractTests(unittest.TestCase):
    ...
    def test_current_version_assets_and_release(self):
        ...
        self.assertIn('0.75.42', content('config/settings.py'))
        self.assertIn('v0.75.42', content('VERSIONS.md'))
        self.assertIn('MAP v0.75.42', content('docs/releases/map/map-v0.75.42.md'))
