...
class MapV07540ContractTests(unittest.TestCase):
    ...
    def test_physical_rack_module_is_loaded_after_v07539(self):
        ...
        new_index = template.index("map-rack-physical-v07541.js")
    ...
    def test_version_is_current(self):
        ...
        release = content("docs/releases/map/map-v0.75.41.md")
        self.assertIn('MAP_VERSION = os.getenv("MAP_VERSION", "0.75.41")', settings)
        self.assertIn('MAP_VERSION: ${MAP_VERSION:-0.75.41}', compose)
        self.assertIn("Mapa | v0.75.41", versions)
        self.assertIn("MAP v0.75.41", release)
