...
class MapV07541ContractTests(unittest.TestCase):
    def test_closest_bug_is_removed(self):
        runtime = content("static/js/map-rack-physical-v07541.js")
    ...
    def test_positions_are_persisted(self):
        runtime = content("static/js/map-rack-physical-v07541.js")
        self.assertIn("rack_units_v07541", runtime)
    ...
    def test_auto_organize_is_available(self):
        runtime = content("static/js/map-rack-physical-v07541.js")
        css = content("static/css/map-rack-physical-v07541.css")
        self.assertIn("Auto organizar", runtime)
        self.assertIn("autoOrganizeRack", runtime)
        self.assertIn("v07541-rack-toolbar", css)
    ...
    def test_new_assets_replace_old_assets(self):
        ...
        self.assertIn("map-rack-physical-v07541.css", template)
        self.assertIn("map-rack-physical-v07541.js", template)
    ...
    def test_versions_are_current(self):
        self.assertIn('MAP_VERSION = os.getenv("MAP_VERSION", "0.75.41")', content("config/settings.py"))
        self.assertIn('MAP_VERSION: ${MAP_VERSION:-0.75.41}', content("docker-compose.yml"))
        self.assertIn("Mapa | v0.75.41", content("VERSIONS.md"))
        self.assertIn("MAP v0.75.41", content("docs/releases/map/map-v0.75.41.md"))
