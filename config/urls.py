...
urlpatterns = [
    ...
    path("mapa/clientes/", map_client_picker, name="map-client-picker"),
    ...
    path("painel/snmp/", company_snmp_defaults, name="company-snmp-defaults"),
    ...
    path("painel/financeiro/faturas/<int:invoice_id>/", company_invoice_detail, name="billing-invoice-detail"),
