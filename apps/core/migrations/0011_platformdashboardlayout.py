...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0010_companydashboardlayout"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="PlatformDashboardLayout",
            fields=[
                ...
                (
                    "banner_text",
                    models.CharField(blank=True, max_length=280, verbose_name="Mensagem no topo da visão da plataforma"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(
