...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Servidores existentes que ficarão somente fora do mapa: {server_count}")
        ...
        with transaction.atomic():
            ...
            # Servidores permanecem no banco/inventário. A v0.74 apenas os oculta do mapa.
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f"{server_count} servidor(es) preservado(s) fora do mapa."
        ))
