(function () {
    ...
    function startTimer() {
        ...
        state.timer = window.setInterval(() => refreshSnapshot({ silent: true }), REFRESH_MS);
    }
    ...
    function injectEquipmentButtons(root = document) {
        ...
        root.querySelectorAll("[data-edit-equipment], [data-edit-container-equipment]").forEach((edit) => {
            ...
            button.textContent = configured ? "SNMP" : "Ativar SNMP";
    ...
    document.addEventListener("visibilitychange", () => {
        ...
        else if (projectSelect.value) refreshSnapshot({ silent: true, force: true });
    });
