...
|---|---:|---|---|---|
| Plataforma | v0.85.0 | `PLATFORM_VERSION` | [CHANGELOG_PLATFORM.md](CHANGELOG_PLATFORM.md) | `platform-vX.Y.Z` |
| Mapa | v0.78.0 | `MAP_VERSION` | [CHANGELOG_MAP.md](CHANGELOG_MAP.md) | `map-vX.Y.Z` |
