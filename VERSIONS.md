...
|---|---:|---|---|---|
| Plataforma | v0.81.3 | `PLATFORM_VERSION` | [CHANGELOG_PLATFORM.md](CHANGELOG_PLATFORM.md) | `platform-vX.Y.Z` |
| Mapa | v0.75.6 | `MAP_VERSION` | [CHANGELOG_MAP.md](CHANGELOG_MAP.md) | `map-vX.Y.Z` |
